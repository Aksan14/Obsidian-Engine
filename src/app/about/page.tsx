    ...
    <div className="space-y-12 max-w-4xl mx-auto">
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
          Solusi terpadu untuk mengelola seluruh aktivitas event UKM dengan sistem digital yang modern dan efisien
        </p>
      </div>
      ...
      <div>
        ...
        <div className="grid sm:grid-cols-3 gap-4">
          ...
          <div className="card text-center">
            ...
            <p className="text-sm text-gray-700">Memfasilitasi kerja sama antar UKM dan unit kampus</p>
          </div>
          <div className="card text-center">
            <div className="text-3xl mb-3">💡</div>
      ...
      {/* Team/Contact CTA */}
      <div className="card text-center bg-gradient-to-r from-red-600 to-red-700 text-white">
